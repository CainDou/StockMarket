...
void CFrmlCompiler::InitSystemVar()
{
	...
	m_SystemVarSet.insert("AMOMACD520");
	m_SystemVarSet.insert("AMOMACD2060");
	m_SystemVarSet.insert("AMORPS520");
	m_SystemVarSet.insert("AMORPS2060");
	m_SystemVarSet.insert("AMORANK520");
	m_SystemVarSet.insert("AMORANK2060");
	m_SystemVarSet.insert("AMOPOINT520");
	m_SystemVarSet.insert("AMOPOINT2060");
	m_SystemVarSet.insert("AMORANK520L1");
	m_SystemVarSet.insert("AMORANK2060L1");
	m_SystemVarSet.insert("AMOPOINT520L1");
	m_SystemVarSet.insert("AMOPOINT2060L1");
	m_SystemVarSet.insert("AMORANK520L2");
	m_SystemVarSet.insert("AMORANK2060L2");
	m_SystemVarSet.insert("AMOPOINT520L2");
	m_SystemVarSet.insert("AMOPOINT2060L2");
	m_SystemVarSet.insert("AMORATIO");
...
void CFrmlCompiler::InitFuncAndVarTrans()
{
	...
	m_FuncTransMap["AMORPS520"] = "520周期成交额的相对强度";
	m_FuncTransMap["AMORPS2060"] = "2060周期成交额的相对强度";
	m_FuncTransMap["AMOMACD520"] = "520周期成交额的MACD值";
	m_FuncTransMap["AMOMACD2060"] = "2060周期成交额的MACD值";

	m_FuncTransMap["AMORANK520"] = "520周期成交额的强度排名";
	m_FuncTransMap["AMORANK2060"] = "2060周期成交额的强度排名";
	m_FuncTransMap["AMOPOINT520"] = "520周期成交额的强度分数";
	m_FuncTransMap["AMOPOINT2060"] = "2060周期成交额的强度分数";

	m_FuncTransMap["AMORANK520L1"] = "520周期成交额的强度在一级行业排名";
	m_FuncTransMap["AMORANK2060L1"] = "2060周期成交额的强度在一级行业排名";
	m_FuncTransMap["AMOPOINT520L1"] = "520周期成交额的强度在一级行业分数";
	m_FuncTransMap["AMOPOINT2060L1"] = "2060周期成交额的强度在一级行业分数";
	m_FuncTransMap["AMORANK520L2"] = "520周期成交额的强度在二级行业排名";
	m_FuncTransMap["AMORANK2060L2"] = "2060周期成交额的强度在二级行业排名";
	m_FuncTransMap["AMOPOINT520L2"] = "520周期成交额的强度在二级行业分数";
	m_FuncTransMap["AMOPOINT2060L2"] = "2060周期成交额的强度在二级行业分数";

	m_FuncTransMap["AMORATIO"] = "成交额分位";
