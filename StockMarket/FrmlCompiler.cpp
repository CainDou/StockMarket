...
void CFrmlCompiler::InitFuncInfo()
{
	...
	fi.frofile = "MACD(5,20,10)";
	fi.description = "返回该周期的MACD(5,20,10)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "MACD2060";
	fi.frofile = "MACD(20,60,10)";
	fi.description = "返回该周期的MACD(20,60,10)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RPS520";
	fi.frofile = "5、20时间窗口的相对强度";
	fi.description = "返回该周期的滑动时间窗口为5、长周期为20的相对强度";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RPS2060";
	fi.frofile = "20、60时间窗口的相对强度";
	fi.description = "返回该周期的滑动时间窗口为20、长周期为60的相对强度";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK520";
	fi.frofile = "RPS520的数值排名";
	fi.description = "返回该周期的RPS520的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK2060";
	fi.frofile = "RPS2060的数值排名";
	fi.description = "返回该周期的RPS2060的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT520";
	fi.frofile = "RPS520的分数";
	fi.description = "返回该周期的RPS520的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT2060";
	fi.frofile = "RPS2060的分数";
	fi.description = "返回该周期的RPS2060的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK520L1";
	fi.frofile = "RPS520在一级行业数值排名";
	fi.description = "返回该周期的RPS520的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK2060L1";
	fi.frofile = "RPS2060在一级行业数值排名";
	fi.description = "返回该周期的RPS2060的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT520L1";
	fi.frofile = "RPS520在一级行业的分数";
	fi.description = "返回该周期的RPS520的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT2060L1";
	fi.frofile = "RPS2060在一级行业的分数";
	fi.description = "返回该周期的RPS2060的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK520L2";
	fi.frofile = "RPS520在二级行业数值排名";
	fi.description = "返回该周期的RPS520的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "RANK2060L2";
	fi.frofile = "RPS2060在二级行业数值排名";
	fi.description = "返回该周期的RPS2060的数值排名";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT520L2";
	fi.frofile = "RPS520在二级行业的分数";
	fi.description = "返回该周期的RPS520的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
	fi.name = "POINT2060L2";
	fi.frofile = "RPS2060在二级行业的分数";
	fi.description = "返回该周期的RPS2060的归一化分数(第一名100分,最后一名0分)";
	m_FuncInfoMap[FT_RPS].emplace_back(fi);
